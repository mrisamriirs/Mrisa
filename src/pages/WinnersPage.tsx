      ...
      <div className="relative z-10 min-h-screen py-12 px-4 sm:px-6 md:px-8">
        <div className="container mx-auto max-w-6xl">
          ...
          >
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-400">Manage event winners and rankings</p>
              </div>
            </div>
            <div className="flex items-center gap-2 w-full sm:w-auto">
              <Button
                onClick={() => setShowNewWinnerForm(!showNewWinnerForm)}
                className="flex-1 sm:flex-none bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-400 hover:to-yellow-500 text-black font-semibold flex items-center justify-center gap-2 h-10 sm:h-11 px-4 text-sm sm:text-base"
              >
          ...
          <motion.div
            ...
            className="fixed bottom-10 left-10 w-40 h-40 bg-yellow-500/5 rounded-full blur-3xl pointer-events-none z-0"
          />
          <motion.div
            animate={{
              boxShadow: [
